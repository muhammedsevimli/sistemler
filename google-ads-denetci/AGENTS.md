# Google Ads Denetçisi · Boşa Giden Reklam Parası + Düzeltme Listesi · Otomatik Okuma Kuralı (AGENTS.md)
...
> Claude Code için aynı kural `CLAUDE.md` dosyasında, Cursor için `.cursor/rules/google-ads-denetci.mdc` dosyasında.
