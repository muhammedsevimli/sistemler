# Carousel + Hook Üretici · Otomatik Okuma Kuralı (AGENTS.md)
...
> Claude Code için aynı kural `CLAUDE.md` dosyasında, Cursor için `.cursor/rules/carousel-uretici.mdc` dosyasında.
