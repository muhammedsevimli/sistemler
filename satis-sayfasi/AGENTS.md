# Satış Sayfası + Ödeme · Ajan Talimatı (AGENTS.md)

> Bu dosya CLAUDE.md ile birebir aynı içeriktedir. Claude Code CLAUDE.md okur; Codex, Cursor, Windsurf gibi diğer araçlar bu dosyayı okur.
