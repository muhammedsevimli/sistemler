# Müşteri Bulucu · Aday Bulma + İlk Mesaj · Otomatik Okuma Kuralı (AGENTS.md)
...
> Claude Code için aynı kural `CLAUDE.md` dosyasında, Cursor için `.cursor/rules/musteri-bulucu.mdc` dosyasında.
