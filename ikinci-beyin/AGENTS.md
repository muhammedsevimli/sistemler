# İkinci Beyin · Otomatik Bağlam Yükleme Kuralı (AGENTS.md)
...
> Claude Code için aynı kural `CLAUDE.md` dosyasında, Cursor için `.cursor/rules/ikinci-beyin.mdc` dosyasında.
