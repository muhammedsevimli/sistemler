# Review Madenci · Müşteri Yorumu Satış Madencisi · Otomatik Okuma Kuralı (AGENTS.md)
...
> Claude Code için aynı kural `CLAUDE.md` dosyasında, Cursor için `.cursor/rules/review-madenci.mdc` dosyasında.
